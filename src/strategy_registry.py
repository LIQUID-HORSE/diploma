...
def build_registry(
    *,
    ...
    if tf not in {"1d", "4h"}:
        raise ValueError(f"Unsupported timeframe={timeframe!r}. Expected one of: '1d', '4h'.")
    ...
    if tf == "1d":
        return [
            ...
            StrategySpec(
                ...
                param_grid={"M": [200, 600, 1200], "n": [20, 50], "k": [2.0, 2.5]},
                group="synergy",
            ),
            StrategySpec(
                code="S3",
    ...
    return [
        StrategySpec(
            ...
            name="SMA_Crossover",
            cls=SMACrossover,
            param_grid={"fast": [5, 10, 30, 60, 120, 300], "slow": [60, 150, 300, 600, 900, 1200, 1800]},
            constraint=lambda p: p.fast < p.slow,
            group="trend",
            save_heatmap=True,
        ),
        ...
        StrategySpec(
            ...
            name="Donchian_Breakout",
            cls=DonchianBreakout,
            param_grid={"N": [30, 120, 300, 600, 1200], "exit": [6, 12, 30, 60, 300]},
            group="trend",
            save_heatmap=True,
        ),
        StrategySpec(
            ...
            name="TSMOM",
            cls=TSMomentum,
            param_grid={"L": [30, 120, 360, 720, 1512]},
            group="momentum",
        ),
        StrategySpec(
            code="R1",
            name="RSI_MR",
            cls=RSIMeanReversion,
            param_grid={"n": [7, 14, 42, 84, 126], "low": [20, 30, 40], "exit": [45, 50, 55]},
            group="meanrev",
        ),
        StrategySpec(
            code="R2",
            name="Bollinger_MR",
            cls=BollingerMeanReversion,
            param_grid={"n": [20, 50, 120, 300, 600], "k": [1.5, 2.0, 2.5], "exit_mode": ["midline", "fixed"]},
            group="meanrev",
        ),
        StrategySpec(
            code="R3",
        ...
        StrategySpec(
            ...
            name="MAFilter_RSI_MR",
            cls=MAFilterRSI,
            param_grid={"M": [200, 600, 1200], "n": [14, 42, 84, 126], "low": [30, 40], "exit": [50, 55]},
            group="synergy",
        ),
        StrategySpec(
            code="S2",
            name="MA200Filter_Bollinger_MR",
            cls=MA200FilterBollinger,
            param_grid={"M": [200, 600, 1200], "n": [20, 50, 120, 300], "k": [2.0, 2.5]},
            group="synergy",
        ),
        StrategySpec(
            code="S3",
            name="Breakout_Confirm_MA",
            cls=BreakoutConfirmMA,
            param_grid={"N": [120, 300, 600, 1200], "M": [300, 600, 1200]},
            group="synergy",
        ),
        StrategySpec(
            code="S4",
            name="MA_Confirm_TSMOM",
            cls=MACrossTSMOMConfirm,
            param_grid={"fast": [10, 30, 60, 180], "slow": [300, 600, 1200], "L": [120, 360, 720, 1512]},
            constraint=lambda p: p.fast < p.slow,
            group="synergy",
        ),
        StrategySpec(
            ...
            name="Ensemble_3Signals",
            cls=SimpleEnsemble,
            param_grid={"ma_pair": [(30, 1200), (120, 1200), (300, 1200)], "N": [300, 1200], "L": [720, 1512]},
            group="synergy",
        ),
    ]
